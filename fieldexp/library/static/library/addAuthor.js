    ...
    var renderForm = function(count){
        var formstring =
            ['<div class="form-group" id="author' + count + '">',
             ...
             '<div class="col-lg-3">',
             '<input type="text" class="form-control" id="firstname' + count + '" name="firstname' + '" placeholder="First name">',
             '</div>',
             '<div class="col-lg-1">',
             '<input type="text" class="form-control" id="mi' + count + '" name="mi' + '" placeholder="MI">',
             '</div>',
             '<div class="col-lg-3">',
             '<input type="text" class="form-control" id="lastname' + count + '" name="lastname' + '" placeholder="Last name">',
             '</div>',
